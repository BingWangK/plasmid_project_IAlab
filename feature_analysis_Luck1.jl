#= feature importance analysis: randomly remove features in combinations of 3 to 20 features. 
	Julia v1.9.1
	MLJ v0.19.2
	DataFrames v1.6.1
       CSV v0.10.11
...
min_comb=3 # min number of elements in combination
