#= feature importance analysis: remove 2 features at one time.
	Julia v1.9.1
	MLJ v0.19.2
	DataFrames v1.6.1
       CSV v0.10.11
...
# define a function to replace values of features with 0
